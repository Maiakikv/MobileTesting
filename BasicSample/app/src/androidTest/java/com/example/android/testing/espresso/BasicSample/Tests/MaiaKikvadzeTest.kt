...
class MaiaKikvadzeTest {
    ...
    fun mainActivityTest() {
        ...
        editText.perform(replaceText("Maia Kikvadze"), closeSoftKeyboard())
        ...
        val textView = onView(
            allOf(
                withId(R.id.show_text_view), withText("Maia Kikvadze"),
                withParent(
                    allOf(
                        withId(android.R.id.content),
        ...
        textView.check(matches(withText("Maia Kikvadze")))
    }
